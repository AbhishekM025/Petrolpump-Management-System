...
def update_for_Petrolpump():
    ...
    df = pd.DataFrame(result, columns=['Registration_No','Petrolpump_Name','Company_Name','Opening_Year','State','City','Tanker_Capacity'])
    ...
    if selected_result:
        Registration_No = selected_result[0][1]
        ...
        Tanker_Capacity = selected_result[0][7]
        with st.container():
    ...
    df2 = pd.DataFrame(result2, columns=['Registration_No','Petrolpump_Name','Company_Name','Opening_Year','State','City','Tanker_Capacity'])
