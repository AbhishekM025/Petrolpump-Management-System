...
def add_Petrolpump_data(Registration_No,Petrolpump_Name,Company_Name,Opening_Year,State,City):
    c.execute('insert into Petrolpump (Registration_No,Petrolpump_Name,Company_Name,Opening_Year,State,City,Tanker_Capacity,No_of_Tanker) values (%s,%s,%s,%s,%s,%s,%s,%s)',(Registration_No,Petrolpump_Name,Company_Name,Opening_Year,State,City) )
    mydb.commit()
